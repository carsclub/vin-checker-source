...
interface EuropeHeroSectionProps {
  onScrollToSearch: () => void;
}

export default function EuropeHeroSection({ onScrollToSearch }: EuropeHeroSectionProps) {
  return (
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="md:text-2xl mb-8 font-normal text-[20px]" data-testid="text-hero-description">
              Enter the 17-digit VIN into our free tool. We decode manufacturer details, model year, and cross-check European databases for vehicle history and specs.
            </p>
            ...
            >
              Decode European VIN Now
            </button>
          </div>

          {/* Right Content - European Features Grid */}
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="bg-white text-black p-6 border-4 border-black shadow-[4px_4px_0px_0px_#000] transform rotate-[-1deg]">
              <div className="transform rotate-[1deg]">
                <h3 className="font-black text-lg mb-2 uppercase">EU Compliance</h3>
                <p className="font-bold text-sm">European emissions standards and regulatory compliance</p>
              </div>
            </div>
            {/* Red - MOT Records */}
            <div className="bg-red-500 text-white p-6 border-4 border-black shadow-[4px_4px_0px_0px_#000] transform rotate-[1deg]">
              <div className="transform rotate-[-1deg]">
                <h3 className="font-black text-lg mb-2 uppercase">MOT Records</h3>
                <p className="font-bold text-sm">Annual inspection and maintenance history</p>
              </div>
            </div>
            ...
            <div className="bg-yellow-400 text-black p-6 border-4 border-black shadow-[4px_4px_0px_0px_#000] transform rotate-[1deg]">
              <div className="transform rotate-[-1deg]">
                ...
                <p className="font-bold text-sm">European technical specifications and features</p>
              </div>
            </div>
            {/* Green - Emissions Data */}
            <div className="bg-green-400 text-black p-6 border-4 border-black shadow-[4px_4px_0px_0px_#000] transform rotate-[-1deg]">
              <div className="transform rotate-[1deg]">
                <h3 className="font-black text-lg mb-2 uppercase">Emissions Data</h3>
                <p className="font-bold text-sm">CO2 ratings and Euro emission standards</p>
              </div>
            </div>
          </div>
        </div>
